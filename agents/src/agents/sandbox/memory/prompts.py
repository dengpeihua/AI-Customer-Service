...
MEMORY_CONSOLIDATION_PROMPT_TEMPLATE = _load_prompt("memory_consolidation_prompt.txt")
MEMORY_READ_PROMPT_TEMPLATE = _load_prompt("memory_read_prompt.txt")
ROLLOUT_EXTRACTION_PROMPT_TEMPLATE = _load_prompt("rollout_extraction_prompt.txt")
ROLLOUT_EXTRACTION_USER_MESSAGE_TEMPLATE = _load_prompt("rollout_extraction_user_message.txt")

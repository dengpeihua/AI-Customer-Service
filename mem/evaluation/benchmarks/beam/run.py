...
DEFAULT_DATASET_DIR = str(DATASETS_DIR / "beam")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default=str(RESULTS_DIR / "beam"), help="Output directory")
    parser.add_argument(
        "--predict-only",
        action="store_true",

...
DEFAULT_DATASET_DIR = str(DATASETS_DIR / "longmemeval")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--answerer-model", default=os.getenv("DEEPSEEK_MODEL") or "gpt-5",
        help="Model for answer generation",
    )
    parser.add_argument(
        "--judge-model", default=os.getenv("DEEPSEEK_MODEL") or "gpt-5",
    ...
    parser.add_argument(
        "--output-dir", default=str(RESULTS_DIR / "longmemeval"),
    ...
    parser.add_argument(
        "--backend", default="oss", choices=["oss"], help="Local Mem0 OSS backend",
    )
    parser.add_argument(
